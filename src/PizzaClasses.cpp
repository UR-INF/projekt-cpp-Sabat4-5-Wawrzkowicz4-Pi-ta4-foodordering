...
const QMap<Ingredient::ToppingType, QString> Ingredient::toppingCategoryNames = {
    ...
    {Ingredient::MIESO, QString("Mięso")},
    {Ingredient::SOS, QString("Sos")},
    {Ingredient::WARZYWA, QString("Warzywa")},
    {Ingredient::SER, QString("Ser")},
    {Ingredient::DODATEK, QString("Dodatek")},
};
...
void Pizza::RemoveComponent(Ingredient ingredient)
{
    ...
    for (int i = 0; i < components.size(); ++i)
    {
        ...
        {
            qDebug() << "Usuniete " << ingredient.GetName();
